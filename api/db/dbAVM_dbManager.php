...
function getConnection() {
	...
	global $db_AVM_db_Url, $db_AVM_db_User, $db_AVM_db_Pass, $db_AVM_db_DbName;
	
	try {
		$dbh = new PDO("mysql:host=".$db_AVM_db_Url.";dbname=".$db_AVM_db_DbName, $db_AVM_db_User, $db_AVM_db_Pass);
